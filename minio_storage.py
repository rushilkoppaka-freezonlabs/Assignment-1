...
def main():
    ...
    for i in range(len(inbox)):
        ...
        result=client.put_object(inbox["username"][i].lower(),  listToString(inbox['file name'][i]).lower(),io.BytesIO(doc[i]), -1 , part_size=10*1024*1024)
