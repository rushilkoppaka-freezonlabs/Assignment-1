        ...
        if 'invoice' in email_message['Subject']:
            ...
            for part in email_message.walk():
                ...
                if bool(file_name):
                    ...
                    email_data['username'], email_data["surname"],email_data['email ID'] = email_message['From'].rsplit(' ')
                    email_data['username']= (email_data['username']+ email_data['surname']).lower()
                    email_data.pop('surname', None)
